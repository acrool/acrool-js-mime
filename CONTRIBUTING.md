...
- Create an [issue](https://github.com/acrool/acrool-js-mime/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-js-mime/issues), assuming one does not already exist.
